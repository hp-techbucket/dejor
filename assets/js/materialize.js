...
;(function($) {
    ...
    init : function(options) {
      ...
      return this.each(function() {
        ...
        var closeModal = function() {
          ...
          $modal.find('.modal-close-materialize').off('click.close');
          $(document).off('keyup.modal-materialize' + overlayID);
        ...
        var openModal = function($trigger) {
          ...
          var $overlay = $('<div class="modal-overlay-materialize"></div>');
          var lStack = (++_stack);
          ...
          if (options.dismissible) {
            ...
            // Return on ESC
            $(document).on('keyup.modal-materialize' + overlayID, function(e) {
          ...
          $modal.find(".modal-close-materialize").on('click.close', function(e) {
            closeModal();
          });
  ...
  $.fn.modal_materialize = function(methodOrOptions) {
    if ( methods[methodOrOptions] ) {
      ...
      $.error( 'Method ' +  methodOrOptions + ' does not exist on jQuery.modal-materialize' );
    }
  };
})(jQuery);
;(function ($) {
