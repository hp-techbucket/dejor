											...
											<thead>
												<tr>
													...
													<div class="mailbox-controls">
														...
														<button type="button" class="btn btn-danger btn-sm deleteButton" title="Delete" data-toggle="modal" data-target="#loginDeleteModal" id="" ><i class="fa fa-trash-o"></i></button>
											...
											<thead>
												<tr>
													...
													<div class="mailbox-controls">
														...
														<!-- Check all button -->
														<button type="button" class="btn btn-default btn-sm checkbox-toggle" title="Select All" <?php echo $disabled; ?>><i class="fa fa-square-o"></i></button>
														<button type="button" class="btn btn-danger btn-sm deleteButton" title="Delete" data-toggle="modal" data-target="#multiDeleteModal" id="" ><i class="fa fa-trash-o"></i></button>
