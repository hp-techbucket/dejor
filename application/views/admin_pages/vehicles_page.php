							...
							?>
								...
								<div class="container">
									<div class="row">
										...
										<?php 
											$message = '';
											if($this->session->flashdata('vehicle_added') != ''){
												$message = $this->session->flashdata('vehicle_added');
											}	
											if($this->session->flashdata('deleted') != ''){
												$message = $this->session->flashdata('deleted');
											}
											if($this->session->flashdata('vehicle_updated') != ''){
												$message = $this->session->flashdata('vehicle_updated');
											}	
...
?>		
		...
		<!-- ADD Vehicle -->
		<form action="<?php echo base_url('admin/add_vehicle'); ?>" id="addVehicleForm" name="addVehicleForm" class="form-horizontal form-label-left input_mask" method="post" enctype="multipart/form-data">
			  ...
			  <div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
						...
						<div class="scrollable">
							...
							<div class="form-group">
								<div class="col-md-4 col-sm-6 col-xs-12">
									...
									<input type="text" name="vehicle_location_city" id="vehicle_location_city" class="form-control">
								</div>
								...
								<div class="col-md-4 col-sm-6 col-xs-12">
									...
									<select name="trader_email" class="form-control" id="trader_email">
										<option value="" selected="selected">Select Trader</option>
										<?php 
											$this->db->from('users');
											$this->db->order_by('id');
											$result = $this->db->get();
											if($result->num_rows() > 0) {
												foreach($result->result_array() as $row){
													...
													echo '<option value="'.$row['email_address'].'">'.$fullname.'</option>';			
												}
											}
										//echo $country_options; 
				  ...
				  <div class="modal-footer">
					...
					<input type="button" class="btn btn-primary btn-update hidden" onclick="javascript:updateVehicle('admin/update_vehicle');" value="Update">
		...
		<!-- ADD Vehicle images -->
		<form action="<?php echo base_url('admin/upload_vehicle_images');?>" id="upload_vehicle_images" name="upload_vehicle_images" method="post" enctype="multipart/form-data">
							...
							<div class="col-md-12 col-sm-12 col-xs-12 desc-container">
								...
								<div class="tab-content">
									...
									<div id="tab1" class="tab-pane fade in active">
										...
										<h5><strong>Trader <span class="glyphicon glyphicon-user"></span></strong> <span id="view-trader" ></span></h5>
