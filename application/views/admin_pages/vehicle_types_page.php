								...
								<div class="row">
									<div class="col-md-12 col-sm-12 col-xs-12">
										<ol class="breadcrumb">
											...
											<li class="active">
												<i class="fa fa-taxi" aria-hidden="true"></i> <?php echo $pageTitle;?>
											</li>
											<li>
												<a href="!#" class="add_vehicle" data-toggle="modal" data-target="#addModal" title="Add New Model"><i class="fa fa-plus"></i> Add New Vehicle Type</a>
											</li>														
										</ol>
									</div>
								</div>
...
?>		
		...
		<!-- ADD Modal -->
		<form action="<?php echo base_url('admin/add_vehicle_type');?>" id="addVehicleTypeForm" class="form-horizontal form-label-left input_mask" name="addVehicleTypeForm" method="post" enctype="multipart/form-data">
			<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			  <div class="modal-dialog" role="document">
				<div class="modal-content">
				  <div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h3 align="center">Add New Vehicle Type</h3>
				  </div>
				  <div class="modal-body">
					...
					<div class="">
						...
						<div class="form-group">
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<input type="text" name="name" class="form-control" id="vName" placeholder="Vehicle Type">
				  ...
				  <div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
					<input type="button" class="btn btn-primary" onclick="javascript:addVehicleType();" value="Add">
		...
		<!-- Edit Modal-->
		<form action="<?php echo base_url('admin/update_vehicle_type');?>" id="updateVehicleTypeForm" name="updateVehicleTypeForm" class="form-horizontal form-label-left input_mask" method="post" enctype="multipart/form-data">
			  ...
			  <div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="">
						<div class="form-group">
							...
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<input type="text" name="name" class="form-control" id="vehicle_name">	
							</div>	
						</div>							
					</div>
				  </div>
				  <div class="modal-footer">
					...
					<input type="button" class="btn btn-primary" onclick="javascript:updateVehicleType();" value="Update">
