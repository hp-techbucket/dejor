					...
					<li class="dropdown search-dropdown"><a class="dropdown-toggle search-icon" data-toggle="dropdown" href="#"><i class="fa fa-search" aria-hidden="true"></i></a>
						<ul class="dropdown-menu">
							<div class="search-container">
								...
								<form action="<?php echo base_url('search');?>" id="search_form" name="search_form" method="post">
...
<?php
	if($pageID != 'home' && $pageID != 'login' && $pageID != 'signup' && $pageID != 'forgot_password' && $pageID != 'vehicles' && $pageID != 'view-vehicle' && $pageID != 'store_vehicles' && $pageID != 'vehicle_search'){
?>
		
	
	<!-- .parallax-container -->
	<div class="parallax-container parallax-container-xs fade">
		
		<div class="parallax-overlay"></div>
		
		<!-- .parallax -->
		<div class="parallax">
			<img src="<?php echo base_url('assets/images/banners/unnamed.jpg');?>">
		...
		<div class="container-medium" align="center">
			...
			<div class="parallax-caption">
				<h4><?php echo html_escape(strtoupper($pageTitle)); ?></h4>
				<div class="custom-breadcrumb">
					...
					<a href="<?php echo base_url('about');?>" title="About Us" class="">About Us</a> 
					<span class="">
						<i class="fa fa-minus fa-lg" aria-hidden="true"></i> 
					</span>
...
<?php
	}else if($pageID == 'login' || $pageID == 'signup' || $pageID == 'forgot_password' || $pageID == 'vehicles'){
?>
...
<?php
	}else if($pageID == 'view-vehicle' || $pageID == 'store_vehicles' || $pageID == 'vehicle_search'){
?>
	...
	<div class="section grey darken-3 fade" align="center">
		...
		<div class="row container-medium">
			...
			<div class="custom-breadcrumb">
				...
				<a href="<?php echo base_url('vehicle-finder');?>" title="Vehicles" class="">Vehicles</a> 
				<span class="">
					<i class="fa fa-minus fa-lg" aria-hidden="true"></i> 
				</span>
				<?php echo html_escape($pageTitle);?>
