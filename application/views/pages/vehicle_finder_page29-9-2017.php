								...
								<li>
									...
									?>
										<div class="checkbox">
											...
											<label for="col_1_filter_<?php echo $no;?>"><?php echo ucwords($row['name']);?></label>
										</div>
									<?php 
											$no++;
								...
								<li>
									...
									?>
										<div class="checkbox">
											...
											<label for="col_3_filter_<?php echo $no;?>"><?php echo ucwords($row['title']);?></label>
										</div>
									<?php 
											$no++;
										}
								...
								<li>
									...
									?>
										<div class="checkbox">
											...
											<label for="col_4_filter_<?php echo $no;?>"><?php echo ucwords($row['title']);?></label>
										</div>
									<?php 
											$no++;
										}
								...
								<li>
									...
									?>
										<div class="checkbox">
											...
											<label for="col_2_filter_<?php echo $no;?>"><?php echo $i;?></label>
										</div>
									<?php 
