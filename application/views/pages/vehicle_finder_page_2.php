	...
	<!-- .section .white -->
	<div class="section grey lighten-3 fade">
			...
			<div class="row" id="row-main">
				...
				<div id="content" class="col-md-10">
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-xs-6">
								<a href="!#" class="btn btn-default display-all">Display all </a>
							</div>
							<div class="col-xs-6">
								<div class="row">
									<div class="form-group input-field col m6 s12 pull-right">
										<input type="text" name="search_listing" id="search_listing" value="<?php echo set_value('search_listing');?>" class="validate">
										<label for="search_listing">Search</label>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="table-responsive">
						...
						<!-- vehicles-table -->
						<table class="table listing-table" cellspacing="0" width="100%">
							<thead class="">
								<tr>
							...
							<tbody>
									<?php
									if($vehicles_listing_array){
										foreach($vehicles_listing_array as $vehicle){
											$thumbnail = '';
											...
											if($sale_status == '0'){
												$sale_status = '<span class="badge bg-green white-text teal darken-2">Available</span>';
											}else{
												$sale_status = '<span class="badge amber lighten-1">Sold</span>';
											}
									?>
										<tr>
											<td width="20%">
											...
											<td>
												...
												<p><?php echo $vehicle->vehicle_type ; ?></p>
												<p>Year - <?php echo $vehicle->year_of_manufacture ; ?></p>
												
												<p>Lot # <?php echo $vehicle->id; ?></p>
											</td>
											
											<td>
											
												<h5><?php echo $vehicle->vehicle_location_city.', '.$vehicle->vehicle_location_country ; ?></h5>
											</td>
											<td>
												<p><?php echo $vehicle->vehicle_odometer ; ?></p>
											</td>	
											<td>
											...
											<td>
												<p class="pull-left"><?php echo $sale_status ; ?></p>
											</td>
											<td>
												
												<a class="btn btn-default" href="#!" onclick="location.href='<?php echo base_url();?>vehicles/<?php echo url_title(strtolower($vehicle->vehicle_make .' '.$vehicle->vehicle_model));?>/<?php echo $vehicle->id;?>/<?php echo $thisRandNum; ?>'" title="View <?php echo $vehicle->vehicle_make .' '.$vehicle->vehicle_model;?>">
									...
									?>
										<tr>
												<td colspan="6"><div class="alert alert-default text-center" role="alert"><i class="fa fa-ban"></i> No listings!</div></td>
										</tr>
