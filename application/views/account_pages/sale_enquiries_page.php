					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
								...
								<div class="row">
									<div class="col-md-12 col-sm-12 col-xs-12">
										<ol class="breadcrumb">
											...
											<li class="active">
												<i class="fa fa-question-circle"></i> <?php echo $pageTitle;?>(<span id="enquiries_unread"><?php echo $enquiries_unread;?></span>)
											</li>
							...
							<?php
								...
								$hidden = array('model' => 'sale_enquiries',);	
							...
							?>
								...
								<div class="container">
									...
									<div class="table-responsive list-tables" >
										...
										<table id="sale-enquiries-table" frame="box" class="display table-hover table-striped bulk_action dt-responsive nowrap" cellspacing="0" width="100%">
											<thead>
												<tr>
