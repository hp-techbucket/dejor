...
$route['team/(:num)/(:any)/(:any)'] = 'main/team/$1/$2/$3';
$route['services'] = 'main/services';
$route['gallery'] = 'main/gallery';
$route['contact-us'] = 'main/contact_us';

$route['vehicle-finder'] = 'main/vehicles_display';
$route['vehicles-search'] = 'main/search_validation';
$route['search'] = 'main/multi_search_validation';

$route['vehicles/(:any)/(:num)/(:any)'] = 'main/view_vehicle/$1/$2/$3';

$route['store/(:any)/(:num)/(:any)'] = 'main/store_display/$1/$2/$3';
...
$route['signup/complete'] = 'main/signup_complete';
...
$route['account/sale-enquiries'] = 'account/sale_enquiries';
...
$route['account/security-success'] = 'account/account/security_success';
