...
class Keyword_icons_model extends MY_Model {
    
    const DB_TABLE = 'keyword_icons';
    const DB_TABLE_PK = 'id';


	var $table = 'keyword_icons';
	...
	public function count_keywords(){
		...
		$count_keywords = $this->db->get($this->table);
				
		if($count_keywords->num_rows() > 0)	{
			$count = $count_keywords->num_rows();
			return $count;
		}else {	
			return false;
		}			
